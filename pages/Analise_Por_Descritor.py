...
# #--------------------------------------------------------------------------------------------------------------------
# #--------------------------------------------------------------------------------------------------------------------
# # 📊 Gráfico Comparativo por Eixo — TFP x Municipal x Estadual

# # 1) Colunas de descritores (mesma lógica usada antes)
...
# # 5) Junta com o mapa EIXO ↔ DESCRITOR e agrega por EIXO
# base_comp = (
...
# # Arredonda e reestrutura para gráfico de barras agrupadas
...
# # Opcional: renomear "TFP" na legenda para algo mais amigável
...
# # 6) Gráfico Plotly — barras agrupadas por EIXO
